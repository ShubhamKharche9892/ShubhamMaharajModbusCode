...
TEST_CASE("Write multiple holding registers", "[FC16]") {
  uint8_t data[] = {0x00, 0x0A, 0x01, 0x02};
  esp32ModbusRTUInternals::ModbusRequest* request = new esp32ModbusRTUInternals::ModbusRequest16(0x11, 0x0001, 0x0002, data);
  uint8_t stdMessage[] = {0x11, 0x10, 0x00, 0x01, 0x00, 0x02, 0x04, 0x00, 0x0A, 0x01, 0x02, 0xC6, 0xF0};
  uint8_t stdResponse[] = {0x11, 0x10, 0x00, 0x01, 0x00, 0x02, 0x12, 0x98};
  uint8_t stdErrorResponse[] = {0x11, 0x90, 0x02, 0x00, 0x00};  // TODO(bertmelis): adjust CRC
